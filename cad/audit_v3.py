...
checks = [
    ...
    ("리프트 SS-5GL 포켓(빔, +X반쪽)", g, (2.5, 7, -52), False),
    ("리프트 +X파일럿(빔, 18°틸트)", g, (7, 8.5, -56.5), False),
    ("리프트 크래들 앵커(솔리드)", g, (9, 7, -52), True),
    ("IMU 보드 리세스(빔, -X)", g, (-6, 24.6, -55), False),
    ("IMU 외피(솔리드, 리세스 뒤)", g, (-16, 24.6, -55), True),
