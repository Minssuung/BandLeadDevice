...
checks = [
    ...
    ("리프트 SS-5GL 포켓(빔)", g, (0, 13, -48), False),
    ("리프트 +X파일럿(빔)", g, (5, 13, -43), False),
    ("리프트 마운팅보스(솔리드)", g, (9, 13, -43), True),
    ("IMU 파일럿(빔, 홀)", g, (-11, 28, -94), False),
    ("IMU 플레이트(솔리드)", g, (-13, 32, -78), True),
    ("허브보드 위립(솔리드, 흔들림방지)", g, (22.5, 5, -14.9), True),
    ("리프트 핀보스(솔리드, 핀지지)", g, (8, 7.5, -32), True),
    ("리프트 핀홀(빔)", g, (0, 5, -32), False),
    ("배선출구 바닥축(빔)", g, (0, 37.2, -93.7), False),
    ("배선출구 옆 +X벽(솔리드)", g, (17, 32.1, -78), True),
    ("트리거 코일 틈(핀 x6, 빔)", g, (6, -25, -9), False),
    ("검지 스프링 그립다리 슬롯(빔)", g, (0, -19, -9), False),
    ("검지 허브 소켓(빔)", g, (0, -22, -9), False),
    ("검지 핀보스(솔리드, 핀지지)", g, (8, -22.5, -9), True),
