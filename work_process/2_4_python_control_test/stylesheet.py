...
def apply_stylesheet(app):
    ...
    combo_arrow = f"{base_dir}/icons/arrow_down.svg"
    spin_up_arrow = f"{base_dir}/icons/arrow_up.svg"
    spin_down_arrow = f"{base_dir}/icons/arrow_down.svg"

    stylesheet = (
        STYLESHEET
        .replace("__COMBO_ARROW__", combo_arrow)
        .replace("__SPIN_UP_ARROW__", spin_up_arrow)
        .replace("__SPIN_DOWN_ARROW__", spin_down_arrow)
    )
